...
\paragraph{Resolución (como ampliación, temario de 2º de Bach):} Aunque un sistema de ecuaciones Compatible Indeterminado tiene infinitas soluciones, no cualquier terna de números es solución. 
%
Es decir, en este caso, la terna $(x,y,z) = (0,0,0)$ no es solución.
%
