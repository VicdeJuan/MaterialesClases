...
\sagestr{asintotesV(f = f,den = f.denominator(normalize=False),AV = AV)}
...
def dominion(f,intervalos_dominio):
    ...
    #print("EEEI:" + str(intervalos_dominio))
    print("EEEI: asignacion")
    global DOM_INTERVALS
    DOM_INTERVALS = DOM_INTERVALS.union(reduce(RealSet.intersection,intervals))
    intervalos_dominio = intervalos_dominio.union(reduce(RealSet.intersection,intervals))
    #print("EEEI: "+str(DOM_INTERVALS))
    print("EEEI:" + str(intervalos_dominio))
