...
\subsubsection{Producto con dominio de operadores en $\real$} Comunmente, multiplicación de un número real por un elemento de $\real^2$.
...
\paragraph{Concreción de lo abstracto} Podemos interpretar $(a,b)\in\real^2$ como vectores con un módulo, una dirección y un sentido. Cuando tenemos en cuenta el origen los llamamos \textbf{vectores fijos}.

Pero claro, para hablar de vectores fijos necesitamos orientarnos en el plano.
%
