...
\begin{itemize}
\item Trigonometría cerrado hasta el parcial.
\item Con vectores hasta el final de la 2ª eval.
\item 3ª evaluación:
\subitem después de semana santa, análisis
\subitem antes, geometría y hasta donde llegamos de cónicas: seccinoes, elipse y circunferencia.
\item Probabilidad en las últimas 2 semanas en las que no hay exámenes.
\end{itemize}
