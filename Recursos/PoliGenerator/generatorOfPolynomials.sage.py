...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_5 = Integer(5); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_1p0 = RealNumber('1.0'); _sage_const_7 = Integer(7); _sage_const_9 = Integer(9); _sage_const_3 = Integer(3); _sage_const_6 = Integer(6); _sage_const_1p2 = RealNumber('1.2'); _sage_const_12 = Integer(12)
import re
var('x')
var('y')
var('z')
...
def _genPolNoRoots(grado,letters,printsol,strfun,coefRank,numTerms):
    return [reduce(__sum,[
                reduce(__prod, [
                    random_not_null(coefRank[_sage_const_0 ],coefRank[_sage_const_1 ],True)*l**random_not_null(_sage_const_1 ,ceil(grado/len(letters)),True) 
                for l in letters])
...
def genPolNoRoots_2024_05_02(letras,grado_max,nTerms,contador):
    return genPolNoRoots(grado = grado_max,
            ...
            coefRank = [-_sage_const_4 ,_sage_const_4 ],
            numTerms = nTerms,
            counter = contador)
...
for a in range(_sage_const_5 ):
    ...
    Enunciado_2024_05_02 += "\\subitem ["+str(a)+"]$" + reduce(_concat_with_plus,[latex(P1[_sage_const_0 ]),latex(P2[_sage_const_0 ]),latex(P3[_sage_const_0 ])]) + "$"
    Solucion_2024_05_02 += "\\subitem ["+str(a)+"]$" + reduce(_concat_with_plus,[latex(P1[_sage_const_0 ]),latex(P2[_sage_const_0 ]),latex(P3[_sage_const_0 ])]) + " = " + latex(P1[_sage_const_0 ]+P2[_sage_const_0 ]+P3[_sage_const_0 ])+ "$"
...
for a in range(_sage_const_5 ):
    ...
    P2 = genPolNoRoots_2024_05_02(letras,grado_max,nTerms,a)
    P3 = genPolNoRoots_2024_05_02(letras,grado_max,nTerms,a)
    Enunciado_2024_05_02 += "\\subitem ["+str(a)+"]$" + latex(P1[_sage_const_0 ])+" + "+latex(P2[_sage_const_0 ])+ "- (" + latex(P3[_sage_const_0 ])+")" + "$"
    Solucion_2024_05_02 += "\\subitem ["+str(a)+"]$" + latex(P1[_sage_const_0 ])+" + "+latex(P2[_sage_const_0 ])+ "- (" + latex(P3[_sage_const_0 ])+")" + " = " + latex(P1[_sage_const_0 ]+P2[_sage_const_0 ]-P3[_sage_const_0 ])+ "$"

## EJERCICIO 4
## Multiplicación de monomios

for a in range(_sage_const_5 ):
    grado_max = _sage_const_3 *_sage_const_12 +_sage_const_1 
    nTerms = _sage_const_1 
    letras = [x,y,z,a,b]
    P1 = genPolNoRoots_2024_05_02(letras,grado_max,nTerms,a)
    P2 = genPolNoRoots_2024_05_02(letras,grado_max,nTerms,a)
    P3 = genPolNoRoots_2024_05_02(letras,grado_max,nTerms,a)
    Enunciado_2024_05_02 += "\\subitem ["+str(a)+"]$ (" + latex(P1[_sage_const_0 ])+") · ("+latex(P2[_sage_const_0 ])+ ")$"
    Solucion_2024_05_02 += "\\subitem ["+str(a)+"]$ (" + latex(P1[_sage_const_0 ])+") · ("+latex(P2[_sage_const_0 ])+ ") = " + latex(P1[_sage_const_0 ]*P2[_sage_const_0 ])+ "$"
