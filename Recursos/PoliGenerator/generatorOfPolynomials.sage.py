...
for a in range(_sage_const_10 ):
    ...
    Enunciado_2024_05_02 += "\\noindent\\subitem ["+str(a)+"]$" + reduce(_concat_with_plus,[latex(P1[_sage_const_0 ].expand()),latex(P2[_sage_const_0 ].expand()),latex(P3[_sage_const_0 ].expand())]) + "$"
    Solucion_2024_05_02 += "\\subitem ["+str(a)+"]$" + reduce(_concat_with_plus,[latex(P1[_sage_const_0 ].expand()),latex(P2[_sage_const_0 ].expand()),latex(P3[_sage_const_0 ].expand())]) + " = " + latex((P1[_sage_const_0 ]+P2[_sage_const_0 ]+P3[_sage_const_0 ]).expand())+ "$"
...
for a in range(_sage_const_10 ):
    ...
    P2 = genPolNoRoots_2024_05_02(letras,grado_max,nTerms,a)
    P3 = genPolNoRoots_2024_05_02(letras,grado_max,nTerms,a)
    Enunciado_2024_05_02 += "\\subitem ["+str(a)+"]$" + reduce(_concat_with_plus,[latex(P1[_sage_const_0 ].expand()),latex(P2[_sage_const_0 ].expand()),latex(P3[_sage_const_0 ].expand())]) + "$"
    Solucion_2024_05_02 += "\\subitem ["+str(a)+"]$" + reduce(_concat_with_plus,[latex(P1[_sage_const_0 ].expand()),latex(P2[_sage_const_0 ].expand()),latex(P3[_sage_const_0 ].expand())]) + " = " + latex((P1[_sage_const_0 ]+P2[_sage_const_0 ]+P3[_sage_const_0 ]).expand())+ "$"
...
for a in range(_sage_const_10 ):
    ...
    P2 = genPolNoRoots_2024_05_02(letras,grado_max,nTerms,a)
    P3 = genPolNoRoots_2024_05_02(letras,grado_max,nTerms,a)
    Enunciado_2024_05_02 += "\\subitem ["+str(a)+"]$" + latex(P1[_sage_const_0 ].expand())+" + "+latex(P2[_sage_const_0 ].expand())+ "- (" + latex(P3[_sage_const_0 ].expand())+")" + "$"
    Solucion_2024_05_02 += "\\subitem ["+str(a)+"]$" + latex(P1[_sage_const_0 ].expand())+" + "+latex(P2[_sage_const_0 ].expand())+ "- (" + latex(P3[_sage_const_0 ].expand())+")" + " = " + latex((P1[_sage_const_0 ]+P2[_sage_const_0 ]-P3[_sage_const_0 ]).expand())+ "$"
...
for a in range(_sage_const_10 ):
    ...
    P2 = genPolNoRoots_2024_05_02(letras,grado_max,nTerms,a)
    P3 = genPolNoRoots_2024_05_02(letras,grado_max,nTerms,a)
    Enunciado_2024_05_02 += "\\subitem ["+str(a)+"]$ (" + latex(P1[_sage_const_0 ].expand())+") · ("+latex(P2[_sage_const_0 ].expand())+ ")$"
    Solucion_2024_05_02 += "\\subitem ["+str(a)+"]$ (" + latex(P1[_sage_const_0 ].expand())+") · ("+latex(P2[_sage_const_0 ].expand())+ ") = " + latex((P1[_sage_const_0 ]*P2[_sage_const_0 ]).expand())+ "$"
