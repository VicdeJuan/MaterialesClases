...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_1p0 = RealNumber('1.0'); _sage_const_25 = Integer(25)
import re
var('x')
...
numToGen= _sage_const_25                 # Numero de polinomios a generar de cada tipo.
...
degree = _sage_const_6                   # Grado maximo de los polinomios.
allPols=[]

for hasDegree2Pols in range(_sage_const_1 ):
    if hasDegree2Pols:
        print "\\section{Con polinomios irreducibles de grado 2}"
    else:
        print "\\section{Sin polinomios irreducibles de grado 2}"

    for rfrac in range(_sage_const_2 ): # rfrac: numero de raices fraccionarias por polinomio.
...
for i in xrange(len(allPols)):
    p=allPols[i]
    print "\\subitem \\begin{dmath*}P_{"+str(i+_sage_const_1 )+"}(x) = " + latex(p.factor())+"\\end{dmath*}\\vspace{-1.2cm}"
print ""
