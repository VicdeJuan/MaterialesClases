...
\textit{Ver \fref{img::funinterpretacionderivadapunto}}
\end{defn}

\subsubsection{Interpretación geométrica de la derivada}

Ver \fref{img::funinterpretacionderivadapunto}.
...
De la misma manera que existía la \textit{continuidad lateral}, también podemos hablar de \concept[Derivabilidad\IS lateral]{derivabilidad lateral}. 
...
\begin{figure}[h!]
\centering
\includegraphics[scale=1.1]{img/DerivabilidadEjerp56-78}
